...
export default function About() {
  ...
  return (
    <div style={{ background: theme.bg, minHeight: '100vh', color: theme.text, transition: 'background 0.4s, color 0.4s' }}>
      ...
      {/* Mission */}
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '96px 72px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'start' }}>
          <div data-reveal="mission" style={{ ...rev('mission') }}>
            ...
            <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '48px', lineHeight: 1, margin: '0 0 28px', letterSpacing: '-0.01em' }}>Naše poslanstvo</h2>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto 80px', padding: '0 72px' }}>
        <div style={{ height: '1px', background: theme.border }} />
      </div>

      {/* Activities */}
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 72px 96px' }}>
        <div data-reveal="activities-header" style={{ ...rev('activities-header'), marginBottom: '48px' }}>
          ...
          <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '48px', lineHeight: 1, margin: 0 }}>Aktivnosti kluba</h2>
        </div>
        <div data-reveal="activities" style={{ ...rev('activities'), display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
          {activities.map((a, i) => (
            <div
              key={i}
      ...
      <div style={{ background: theme.bgAlt, borderTop: `1px solid ${theme.border}`, padding: '96px 0', transition: 'background 0.4s' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 72px' }}>
          <div data-reveal="team-header" style={{ ...rev('team-header'), marginBottom: '48px' }}>
            ...
            <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '48px', lineHeight: 1, margin: 0 }}>Vodstvo kluba</h2>
          </div>
          <div data-reveal="team" style={{ ...rev('team'), display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
            {team.map((m, i) => (
              <div
                key={i}
